                ...
                <form action="{{ route('admin.product.update',$product) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="select-box-container row justify-content-between align-items-start">
                        ...
                        <div class="col-5 mt-4">
                            <div class="mb-4">
                                <input name="name" type="text" value="{{ $product->name }}" placeholder="نام محصول" class="form-control">
                            </div>
                            <div class="input-group mb-4">
                                <input name="price" type="text" value="{{ number_format($product->price) }}" placeholder="قیمت محصول" class="form-control">
                        ...
                        <div class="col-6 mt-4">
                            ...
                            <button name="sub3" type="submit" class="btn btn-success mt-4 mx-auto d-block">ویرایش محصول
