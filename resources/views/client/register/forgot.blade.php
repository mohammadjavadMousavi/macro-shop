...
<body>
  ...
  <div class="form-container mt-5">
    ...
    <div class="form-wrapper">
      ...
      <p class="text-secondary text-center">پس از وارد کردن ایمیل  کد یکبار مصرف به ایمیل شما ارسال می شود.</p>
      <form action="{{ route('client.login.forgotPass') }}" method="post" class="main-form mt-5">
        ...
        <button name="sub" type="submit" class="submit-btn btn">بازیابی رمز عبور</button>
      </form>
    </div>
  </div>
  <!-------------------------- SCRIPTS LINK -------------------------->
