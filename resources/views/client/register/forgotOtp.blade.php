...
<body>
  ...
  <div class="form-container mt-5">
    ...
    <div class="form-wrapper">
      ...
      <p class="text-secondary text-center">کد ارسال شده به ایمیلتان را وارد کنید</p>
      <form action="{{ route('client.login.forgotPassCode',$user) }}" method="post" class="main-form mt-5">
        ...
        <button name="sub" type="submit" class="submit-btn btn">بازیابی حساب</button>
      </form>
    </div>
  </div>
  <!-------------------------- SCRIPTS LINK -------------------------->
